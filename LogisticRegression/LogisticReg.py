...
def rand_grad_ascent(dataMat, labelMat, maxCycles):
...
def plotWeights(weights_array1, weights_array2):
    ...
    axs0_title_text = axs[0][0].set_title(u'rand_grad_ascend')
    ...
    axs2_xlabel_text = axs[2][0].set_xlabel(u'maxCycles')
    ...
    axs0_title_text = axs[0][1].set_title(u'grad_ascend')
    ...
    axs2_xlabel_text = axs[2][1].set_xlabel(u'maxCycles')
...
if __name__ == '__main__':
    ...
    weights_2, weights_array_2 = grad_ascent(dataMat, labelMat, 2000)
