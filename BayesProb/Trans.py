...
MODEL_DIR = "F:/TensorFlow on Android/lib/pb"
MODEL_NAME = "gender_model.pb"
...
def freeze_graph(model_folder):
    ...
    with tf.Session() as sess:
        ...
        # print("predictions : ", sess.run("predictions:0", feed_dict={
        #     "input_holder:0": [10.0]}))  # 测试读出来的模型是否正确，注意这里传入的是输出 和输入 节点的 tensor的名字，不是操作节点的名字
